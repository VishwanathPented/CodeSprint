...
const TheoryResults = ({ result, section, count, onBack }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className={clsx('relative overflow-hidden rounded-2xl p-8 mb-6 text-center',
        ...
        <p className="font-bold text-lg opacity-90 mb-1">{summary.correct} correct out of {summary.attempted}</p>
